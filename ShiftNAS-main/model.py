...
import numpy as np
from genotypes import shiftNAS_final_C10
import time
...
class AuxiliaryHeadCIFAR(nn.Module):
  ...
  def __init__(self, C, num_classes):
    ...
    self.classifier = LinearShift(768, num_classes)
...
class NetworkCIFAR(nn.Module):
  ...
  def __init__(self, C, num_classes, layers, auxiliary, genotype):
    ...
    self.stem = nn.Sequential(
      Conv2dShift(3, C_curr, 3, padding=1, bias=False),
    ...
    self.classifier = LinearShift(C_prev, num_classes)
