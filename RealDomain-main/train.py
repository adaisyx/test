...
#training setting
parser.add_argument('--data', type=str, default='../ShiftNAS-main/data', help='location of the data corpus')
...
parser.add_argument('--save', type=str, default='DOTS', help='experiment name')
...
parser.add_argument('--arch', type=str, default='DOTS_final_C100', help='which architecture to use')
...
#     sys.exit(1)
    ...
    #optimizer = RAdam(params_dict, args.learning_rate, weight_decay=args.weight_decay)
